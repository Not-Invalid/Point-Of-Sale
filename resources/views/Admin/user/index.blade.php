...
<div class="flex justify-between mt-8">
    ...
    <div class="flex justify-end mb-4 mt-10">
        <a href="{{route('user.create')}}" class="bg-red-600 text-white flex items-center px-4 font-medium text-xs sm:text-sm md:text-base py-1 sm:py-2 rounded-lg drop-shadow-lg">Add User</a>
    </div>
</div>
